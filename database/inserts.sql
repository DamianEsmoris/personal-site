...
('Ciclo básico', 'formal', '2017/03/01', '2019/12/25', 'Liceo 2 Atlántida.', NULL),
('1ero bachillerato en robótica', 'formal', '2020/03/01', '2020/12/25', 'UTU Atlántida.', NULL),
...
('Ingenería en computación', 'formal', '2024/07/01', NULL, 'Materias aprobadas: P1, Matemática inicial', NULL);
